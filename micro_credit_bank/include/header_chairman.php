					...
					<div class="w3-bar w3-green">
						...
						<div class="w3-dropdown-hover">
							...
							<div class="w3-dropdown-content w3-bar-block w3-card-4">
								...
								<a href="edit_profile.php?designation=Chairman" class="w3-bar-item w3-button w3-teal"> Profile </a>
						...
						<div class="w3-dropdown-hover">
							...
							<button class="w3-button w3-wide w3-border w3-border-teal w3-round-large w3-margin-right"> Loan </button>

							<div class="w3-dropdown-content w3-bar-block w3-card-4">
								<a href="edit_loan.php" class="w3-bar-item w3-button w3-teal"> Edit loan </a>
								<a href="loan_detail.php" class="w3-bar-item w3-button w3-teal"> Detail </a>
							</div>
	             	
						</div>

							<a href="home.php?logout=yes" class="w3-bar-item w3-button w3-wide w3-border w3-border-teal 				w3-round-large w3-margin-right" >  <label class="w3-tiny">  <?php echo $_SESSION['designation']; ?> </label> Logout
							</a>
