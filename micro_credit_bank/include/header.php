	...
	<body class="w3-container" style="padding:0px;margin:0px;" onload = startTime()>
		...
		<div class="w3-row-padding w3-border w3-green w3-cell-row ">
			...
			<div class="w3-cell w3-col w3-container m2 l2">
		    	<a href="index.php"><img alt="mcb_logo" src="images/mcb_logo.jpg" width="180px" height="150px"/></a>
			</div>

			<div class="w3-cell w3-col w3-container m9 l9" style="font-family: sans-serif; margin-top: 20px;">  
