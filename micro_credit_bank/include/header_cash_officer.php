			...
			<div class="w3-cell w3-col w3-container m9 l9" style="font-family: sans-serif;">  
				...
				<div class="w3-cell-row">
					...
					<div class="w3-bar w3-green">
						...
						<a href="edit_profile.php?designation=Cash Officer" class="w3-bar-item w3-button w3-wide w3-border w3-border-teal w3-round-large w3-margin-right"> Edit Profile </a>
						...
						<div class="w3-dropdown-hover">
							...
							<button class="w3-button w3-wide w3-border w3-border-teal w3-round-large w3-margin-right"> Payment </button>
							
							<div class="w3-dropdown-content w3-bar-block w3-card-4">
								<a href="payment.php" class="w3-bar-item w3-button w3-teal"> Action </a>
								<a href="payment_detail.php" class="w3-bar-item w3-button w3-teal"> Detail </a>
								<a href="payment_search.php" class="w3-bar-item w3-button w3-teal"> Search </a>
							</div>
