			...
			<div class="w3-cell w3-col w3-container m9 l9" style="font-family: sans-serif;">  
				...
				<div class="w3-cell-row">
					...
					<div class="w3-bar w3-green">
						...
						<a href="edit_profile.php?designation=Manager" class="w3-bar-item w3-button w3-wide w3-border w3-border-teal w3-round-large w3-margin-right"> Edit Profile </a>
