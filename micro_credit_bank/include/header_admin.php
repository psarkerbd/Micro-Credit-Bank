			...
			<div class="w3-cell w3-col w3-container m9 l9" style="font-family: sans-serif;">  
				...
				<div class="w3-cell-row">
					...
					<div class="w3-bar w3-green">
						...
						<a href="edit_profile.php?designation=" class="w3-bar-item w3-button w3-wide w3-border w3-border-teal w3-round-large w3-margin-right"> Edit Profile </a>
						...
						<div class="w3-dropdown-hover">
							...
							<div class="w3-dropdown-content w3-bar-block w3-card-4">
								...
								<a href="pro_customer_detail.php" class="w3-bar-item w3-button w3-teal"> Customer </a>
