		...
		if($cnt_table > 0)
		{
			...
			if($flag)
			{
				...
				else
				{
					...
					$sql = "INSERT INTO payment(amount_paid, due_amount, late_fine, payment_date, loan_id, national_id,) 
						VALUES ('$loan_amount', $due_amount, '0', '$loan_date', '$loan_id', '$national_id') ";
